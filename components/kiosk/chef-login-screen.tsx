...
import { ChefHat, Loader2, Phone, Lock } from "lucide-react";
...
export function ChefLoginScreen() {
  ...
  return (
    <div
      className="flex h-screen flex-col items-center justify-center gap-8 bg-slate-950 select-none overflow-hidden"
      onContextMenu={(e) => e.preventDefault()}>
      <div className="flex flex-col items-center gap-4 mb-2">
        <div className="flex items-center justify-center">
          <div className="rounded-full bg-slate-900 p-6 border border-slate-700">
            <ChefHat
      ...
      <div className="flex w-80 flex-col gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="h-14 pl-12 bg-slate-900 border-slate-700 text-lg text-slate-100 placeholder:text-slate-600 focus:ring-blue-500/50 rounded-lg"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div
            ...
            {[0, 1, 2, 3].map((index) => (
              <div
                key={index}
                className={`flex h-16 w-16 items-center justify-center rounded-lg bg-slate-900 border ${
                  pin.length === index
        ...
        <Button
          ...
          size="lg"
          className="h-14 text-lg gap-2 rounded-lg bg-blue-600 hover:bg-blue-500 disabled:opacity-30 mt-2">
          {loading ? (
